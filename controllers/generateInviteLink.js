...
export const generateInviteLink = async (req, res) => {
  ...
  try {
    ...
    const inviteLink = `https://dazzling-squirrel-e5a380.netlify.app/game?inviter=${inviter}&invitee=${invitee}&score=${user.score}`;
...
export const acceptInvite = async (req, res) => {
  ...
  try {
    ...
    res.json({
      message: `Welcome, ${invitee}! You’ve accepted the challenge.`,
    });
  } catch (error) {
